def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":8,"deepwell_type":"nest_96_wellplate_2ml_deep","res_type":"nest_12_reservoir_15ml","starting_vol":400,"binding_buffer_vol":220,"wash1_vol":500,"wash2_vol":500,"wash3_vol":500,"elution_vol":50,"mix_reps":15,"settling_time":7,"park_tips":false,"tip_track":false,"flash":false}""")
...
resuming.')
    ...
    def stop_reaction(vol, source, mix_reps=6, park=True, resuspend=True):
        ...
        for stop in np.arange(settling_time,0,-0.5):
            ctx.delay(minutes=0.5,msg='There are ' + str(stop) + ' minutes left in pelleting.')
    ...
    wash(300, wash5, park=park_tips)
    wash(300, wash6, park=park_tips)
