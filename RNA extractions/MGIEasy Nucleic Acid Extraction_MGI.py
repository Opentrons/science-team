def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":96,"deepwell_type":"nest_96_wellplate_2ml_deep","res_type":"nest_12_reservoir_15ml","starting_vol":200,"binding_buffer_vol":460,"wash1_vol":400,"wash2_vol":400,"wash3_vol":600,"elution_vol":50,"mix_reps":15,"settling_time":2,"park_tips":false,"tip_track":false,"flash":false}""")
...
metadata = {
    'protocolName': 'MGIEasy Nucleic Acid Extraction',
...
resuming.')
    ...
    def bind(vol, park=True):
        ...
        ctx.delay(minutes=10, msg='incubate for 10 minutes at room temperature')
