def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":8,"deepwell_type":"nest_96_wellplate_2ml_deep","res_type":"nest_12_reservoir_15ml","starting_vol":400,"binding_buffer_vol":320,"wash1_vol":400,"wash2_vol":400,"wash3_vol":300,"elution_vol":50,"mix_reps":15,"settling_time":7,"park_tips":false,"tip_track":false,"flash":false}""")
...
metadata = {
    'protocolName': 'Mag-Bind® Total RNA 96 Kit',
...
resuming.')
    ...
    def bind(vol, park=True):
        ...
        BindIncubate = 5
        for binddelay in np.arange(BindIncubate, 0, -1): #Bind delay countdown- BindIncubate minutes long
