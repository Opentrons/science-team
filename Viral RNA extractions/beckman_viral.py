def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":48,"starting_vol":200,"binding_buffer_vol":200,"wash1_vol":400,"wash2_vol":400,"wash3_vol":400,"elution_vol":40,"mix_reps":10,"settling_time":5,"park_tips":false,"tip_track":false,"flash":false}""")
...
metadata = {
    'protocolName': 'Beckman Coulter Viral Kit',
