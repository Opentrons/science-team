def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":96,"starting_vol":435,"binding_buffer_vol":565,"wash1_vol":900,"wash2_vol":450,"wash3_vol":450,"elution_vol":60,"mix_reps":10,"settling_time":1,"park_tips":true,"tip_track":false,"flash":false}""")
...
def run(ctx):
    ...
    res1 = ctx.load_labware(
        'nest_12_reservoir_15ml', '3', 'reagent reservoir 1')
...
' + str(settling_time) + ' minutes.')
    ...
    def wash(vol, source, set_ind, mix_reps=15, removal_pct=1, park=True, resuspend=True):
        """
