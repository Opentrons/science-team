def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":48,"starting_vol":200,"binding_buffer_vol":200,"wash1_vol":400,"wash2_vol":400,"wash3_vol":400,"elution_vol":30,"mix_reps":10,"settling_time":5,"park_tips":true,"tip_track":false,"flash":false}""")
...
metadata = {
    'protocolName': 'BP genomics Extraction',
...
' + str(settling_time) + ' minutes.')
    ...
    def wash(vol, source, mix_reps=15, park=True, resuspend=True):
        ...
        ctx.delay(minutes=5, msg='Incubate with Magdeck disengaged for 5 minutes')
...
' + str(settling_time) + ' minutes.')
    ...
    def elute(vol, park=True):
        ...
        ctx.delay(minutes=5, msg='Incubating with Magdeck disengaged for 5 minutes')
        magdeck.engage(height=MAG_HEIGHT)
    ...
    ctx.delay(minutes=5, msg='Drying beads')
