...
def run(context):
    ...
    # 96 samples
    # A1- F Primer 60ul add 100 total
    # B1- R Primer 60ul  add 100 total
    # B3- Mastermix 1500ul Add 1700ul total
    # B4- Water 1260 add 1400ul total
    # A3- Empty 50ml eppendorf
    # C1- 120ul DNA add 150ul total
