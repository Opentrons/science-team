def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":8,"deepwell_type":"nest_96_wellplate_2ml_deep","res_type":"nest_12_reservoir_15ml","starting_vol":650,"binding_buffer_vol":350,"wash1_vol":500,"wash2_vol":500,"wash3_vol":500,"elution_vol":90,"mix_reps":15,"settling_time":8,"park_tips":false,"tip_track":false,"flash":false}""")
